...
import logging
import os
from app.models import CustomerFeatures, PredictionResponse, HealthResponse # Importe les schémas
...
# NOTE: Le modèle est sauvegardé dans model/churn_model.pkl par votre script train_model.py
...
def predict(features: CustomerFeatures):
    ...
    try:
        # Preparation des features (Doit correspondre à l'ordre d'entrainement)
        input_data = np.array([[
